...
function loadClassifiers() {
    ...
    const faceCascadePath = window.location.origin + '/static/models/haarcascade_frontalface_alt2.xml';
    ...
    const eyeCascadePath = window.location.origin + '/static/models/haarcascade_eye.xml';
